---
title: Tunnel Labels
description: Labelgate Tunnel 标签属性的完整参考。
---
...
<Callout type="info">
使用 tunnel 模式时，Cloudflare 会自动为 hostname 创建一个指向你的 tunnel 的 CNAME DNS 记录。你不需要创建单独的 DNS 记录。
</Callout>

## Origin Request Configuration

微调 cloudflared 和你的源服务之间的连接：
